...
<tr>
<c:url value="/resources/images/products/${cartItem.xPS.productid}.jpg" var="url"></c:url>
<td class="col-md-4"><img src="${url}" width="100" height="80" style="border-radius:15px"/>   </td>

<td class="col-md-5"><c:url value="/resources/images/suppliers/${cartItem.xPS.supplierid}.jpg" var="url"></c:url>
...
<td class="col-md-1" style="text-align: center">${cartItem.xPS.psprice}</td>
...
<button class="btn btn-default" name="_eventId_backTocollectShippingAddr">Back</button>

<input type="submit" value="Submit Order" class="btn btn-default" name="_eventId_confirmedOrder" />
